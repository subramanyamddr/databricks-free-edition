...
dbutils.widgets.text("tables_metadata", "")

run_id = dbutils.widgets.get("run_id")
tables_metadata = dbutils.widgets.get("tables_metadata")

if not run_id or not tables_metadata:
    raise ValueError("run_id and tables_metadata are required")

tables_metadata = json.loads(tables_metadata.replace("'", '"'))

table_id = tables_metadata["table_id"]
table_name = tables_metadata["table_name"]
